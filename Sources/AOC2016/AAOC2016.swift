...
@main
struct AOC2016: ParsableCommand, AsyncParsableCommand {
    ...
    func run() async throws {
        ...
        guard let part = AOC2016Core.Part(rawValue: part) else {
            throw Error.invalidPart
        }
        try await AOC2016Core.AOC2016(testInput: useTestInput).run(day: day, part: part)
    }
}
